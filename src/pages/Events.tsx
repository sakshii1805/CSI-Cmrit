          ...
          <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
            <div className="relative w-full md:max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-9 py-2.5 text-xs sm:text-sm rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 bg-slate-50/50"
              />
              {searchQuery && (
                <button
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto w-full md:w-auto min-w-0 max-w-full py-1 scrollbar-none overscroll-x-contain">
