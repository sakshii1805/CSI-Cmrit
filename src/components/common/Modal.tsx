...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Modal Dialog */}
      <div 
        className={`relative w-full ${maxWidthStyles[maxWidth]} bg-white rounded-2xl shadow-elevated border border-slate-200/80 overflow-hidden transform transition-all z-10`}
      >
        {/* Header */}
        {title && (
