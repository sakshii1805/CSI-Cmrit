      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="h-10 w-11 rounded-lg bg-white border border-slate-700/60 flex items-center justify-center p-0.5 shadow-xs group-hover:border-blue-400 group-hover:shadow-glow-blue transition-all shrink-0 overflow-hidden">
              <img
