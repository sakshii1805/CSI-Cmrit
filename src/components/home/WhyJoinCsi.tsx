  ...
  return (
    <section className="py-20 lg:py-24 bg-white border-b border-slate-200 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full max-w-5xl mx-auto rounded-2xl bg-gradient-to-br from-slate-50 via-blue-50/40 to-indigo-50/30 border border-slate-200/90 p-8 sm:p-10 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center md:text-left space-y-2 max-w-xl">
          ...
          <div className="relative z-10 flex items-center gap-3 sm:gap-4 flex-wrap justify-center shrink-0">
            <Link
              to="/join"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 transition-all shadow-sm hover:shadow hover:-translate-y-0.5 active:translate-y-0"
            >
            ...
            <Link
              to="/about"
              className="inline-flex items-center px-5 py-3 rounded-xl text-sm font-semibold text-slate-700 hover:text-slate-900 bg-white hover:bg-slate-50 border border-slate-200 transition-all shadow-xs hover:border-slate-300"
            >
              Learn More About Us
            </Link>
          </div>
        ...
        {/* Social Follow Strip */}
        <div className="mt-10 pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white hover:bg-pink-50/60 border border-slate-200 hover:border-pink-200 text-slate-700 hover:text-pink-600 text-xs font-medium transition-all shadow-xs"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white hover:bg-blue-50/60 border border-slate-200 hover:border-blue-200 text-slate-700 hover:text-blue-600 text-xs font-medium transition-all shadow-xs"
            >
